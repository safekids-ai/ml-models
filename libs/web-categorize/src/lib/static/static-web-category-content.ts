...
export const DOWNLOADS = new Map<StaticWebCategory, FileDownload[]>([
  [StaticWebCategory.ADULT_MIXED, ADULT_MIXED],
  [StaticWebCategory.ADULT_ANIME, ADULT_ANIME],
  [StaticWebCategory.PORN, PORN],
  [StaticWebCategory.PROXY_VPN_DDNS, PROXY_VPN_DDNS],
  [StaticWebCategory.GAMBLING, GAMBLING],
  [StaticWebCategory.PIRACY, PIRACY],
  [StaticWebCategory.TRACKERS_ADWARE_MALWARE, TRACKERS_ADWARE_MALWARE],
  [StaticWebCategory.STALKERWARE, STALKERWARE],
  [StaticWebCategory.CRYPTO_JACKING, CRYPTO_JACKING],
  [StaticWebCategory.PHISHING, PHISHING],
  [StaticWebCategory.HACKING, HACKING],
  [StaticWebCategory.DDOS, DDOS],
  [StaticWebCategory.DOH_DNS, DOH_DNS],
  [StaticWebCategory.UNSAFE_SEARCH, UNSAFE_SEARCH],
  [StaticWebCategory.URL_SHORTNER, URL_SHORTNER],
  [StaticWebCategory.FAKE_NEWS, FAKE_NEWS],
  [StaticWebCategory.DRUGS, DRUGS],
  [StaticWebCategory.DANGEROUS_FORUMS, DANGEROUS_FORUMS],
  [StaticWebCategory.MISC_DANGEROUS_MATERIAL, MISC_DANGEROUS_MATERIAL],
  [StaticWebCategory.INAPPROPRIATE_MATERIAL, INAPPROPRIATE_MATERIAL],
  [StaticWebCategory.SOCIAL_MEDIA, SOCIAL_MEDIA],
  [StaticWebCategory.CHAT, CHAT],
  [StaticWebCategory.DATING, DATING],
  [StaticWebCategory.SHOPPING, SHOPPING],
  [StaticWebCategory.ENTERTAINMENT_CELEBRITY, ENTERTAINMENT_CELEBRITY],
  [StaticWebCategory.SEX_EDUCATION, SEX_EDUCATION],
  [StaticWebCategory.SPORTS, SPORTS],
  [StaticWebCategory.RACY_LINGERIE, RACY_LINGERIE],
  [StaticWebCategory.GAMING, GAMING],
])
