...
import {ComposeOption, FlagOption, InBoxSdkHandler} from "../InBoxSdkHandler";
import {InBoxEventHandler} from "./InBoxEventHandler";
...
export class InboxDialogs implements IInboxDialogs {
    ...
    async doLoad() : Promise<void> {
        this.readPRR.innerHTML = await loadHtml("./public/html/prrRead.html");
        this.composePRR.innerHTML = await loadHtml("./public/html/prrCompose.html");
        this.flagPRR.innerHTML = await loadHtml("./public/html/prrFlag.html");
        this.helpPRR.innerHTML = await loadHtml("./public/html/prrHelp.html");
    }
