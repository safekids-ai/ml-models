...
import {CheckboxArea, Container, StyledCheckbox} from './styles';
...
export const Footer: React.FC = () => {
    ...
    const { environment, debug, logging, mlEnabled, enablePRTrigger, nlpEnabled, showClean, enableBlocker, enableDemo, extensionEnabled } =
    ...
    return (
        <Container>
            ...
            <CheckboxArea>
                <StyledCheckbox data-testid="extensionEnabledCB" checked={extensionEnabled} onChange={() => dispatch(setExtensionEnabled(!extensionEnabled))}>
                    {'Enable Extension'}
                </StyledCheckbox>
            </CheckboxArea>
            <div>
