...
import PrrLevel2CountDown from '@src/pages/ui-prr/Main/PrrLevel2/PrrLevel2CountDown';
    ...
    return (
        <>
            {prrLevel2CountDownScreen ? (
                <PrrLevel2CountDown language={language} category={category} level={level} siteName={siteName} prr2LimitExceeded={prr2LimitExceeded} />
            ) : (
                <>
                    <IconsSection>
                        <ContainerLevel3>
