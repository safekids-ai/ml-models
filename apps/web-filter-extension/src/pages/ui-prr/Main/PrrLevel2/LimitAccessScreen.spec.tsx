...
import * as Common from '../../../../pages/ui-prr/Main/common';
...
const Component = <LimitAccessScreen level={PrrLevel.ONE} language={defaultLanguage} category="EXPLICIT" siteName="www.google.com" />;
