...
import {totalQuestions} from '@pages/ui-onboarding/GetStartedContainer/NewFeedback/Feedback.config';
import {
  ButtonSection,
  Root,
  SectionSplitter,
  TextSection
} from '@pages/ui-onboarding/GetStartedContainer/NewFeedback/Feedback.style';
import {Props} from '@pages/ui-onboarding/GetStartedContainer/NewFeedback/Feedback.type';
...
const Feedback = ({onboardingFeedbackComplete, currentOnboardingStep}: Props): JSX.Element => {
  ...
  return (
    <Root>
      <img className="onboarding-feedback-img" src="/assets/images/getStartedAlt.png" alt="safeKidsAiLogo"/>
      <SectionSplitter>
