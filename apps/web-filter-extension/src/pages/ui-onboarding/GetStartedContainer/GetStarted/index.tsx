...
import { Root, ImageContainer } from '@src/pages/ui-onboarding/GetStartedContainer/GetStarted/GetStarted.style';
...
const GetStarted = ({ getStartedClicked }: Props): JSX.Element => {
    ...
    return (
        <Root>
            ...
            <ImageContainer>
                <img src="/images/getStarted.png" alt="Onboarding family image" />
