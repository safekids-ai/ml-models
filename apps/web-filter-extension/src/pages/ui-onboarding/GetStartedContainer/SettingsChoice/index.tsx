...
import {
  ...
  TopContentSection,
  ButtonSection
} from '@pages/ui-onboarding/GetStartedContainer/SettingsChoice/settingsChoice.style';
import {Props} from '@pages/ui-onboarding/GetStartedContainer/SettingsChoice/settingsChoice.type';
