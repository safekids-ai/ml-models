...
import {Root} from '@pages/ui-onboarding/GetStartedContainer/ThankYou/ThankYou.style';
import {Props} from '@pages/ui-onboarding/GetStartedContainer/ThankYou/ThankYou.type';
    ...
    <Root>
      ...
      <div className="images-container">
        <div className="image-container">
          <img src="/assets/images/thankyou-laptop-1.svg" alt="laptop-1"/>
          <span>{defaultMessages.thank_you_laptop1Text}</span>
        </div>
        <div className="image-container">
          <img src="/assets/images/thankyou-laptop-2.svg" alt="laptop-2"/>
        ...
        <div className="image-container">
          <img src="/assets/images/thankyou-laptop-3.svg" alt="laptop-3"/>
