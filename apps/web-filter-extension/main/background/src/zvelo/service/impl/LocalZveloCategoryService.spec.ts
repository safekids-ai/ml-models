...
describe('Local Zvelo category service test', () => {
  ...
  describe('LOCAL - Initialize zvelo categories from file', () => {
    it('Should initialize zvelo categories from file', async () => {
      //given
      const categories = {
        url: 'facebook.com',
        codes: [10094],
    ...
    it('Should retry to initialize zvelo categories from file', async () => {
      //given
      const categories = {
        url: 'facebook.com',
        codes: [10094],
    ...
    it('Should retry to initialize zvelo categories from file if loading fails', async () => {
      //given
      const categories = {
        url: 'facebook.com',
        codes: [10094],
