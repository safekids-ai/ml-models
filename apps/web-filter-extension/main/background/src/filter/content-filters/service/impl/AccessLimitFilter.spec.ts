...
describe('Access limit filter service test', () => {
  ...
  beforeEach(async () => {
    ...
    const restZvelloService = new RESTWebCategoryCategoriesService(new LRUCache<string, number[]>(200), logger);
    urlCategoryService = new WebCategoryUrlCategoriesService(localService, restZvelloService);
