...
import {Root, ImageContainer} from '@src/GetStartedContainer/GetStarted/GetStarted.style';
import {Props} from '@src/GetStartedContainer/GetStarted/GetStarted.type';
  ...
  return (
    <Root>
      <div className="text-container">
        ...
        <img src="/pages/onboarding/images/safekidsAiLogo.svg" alt="SafeKids Logo"/>
      ...
      <ImageContainer>
        <img src="/pages/onboarding/images/getStarted.png" alt="Onboarding family image"/>
