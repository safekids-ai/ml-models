...
import Footer from '@src/GetStartedContainer/footer';
import GetStarted from '@src/GetStartedContainer/GetStarted';
import {Root} from '@src/GetStartedContainer/GetStartedContainer.style';
import Login from '@src/GetStartedContainer/Login';
import Feedback from '@src/GetStartedContainer/NewFeedback';
import SettingsChoice from '@src/GetStartedContainer/SettingsChoice';
import ThankYou from '@src/GetStartedContainer/ThankYou';
        ...
        <>
          {(getStarted || loginComplete) && (
            <div className="header">
              <img src="/pages/onboarding/images/safekidsAiLogo.svg" alt="safeKidsAiLogo"/>
              <p>at Home</p>
            </div>
          )}
          <>
