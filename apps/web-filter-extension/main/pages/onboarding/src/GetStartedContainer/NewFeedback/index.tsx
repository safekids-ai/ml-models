...
import {totalQuestions} from '@src/GetStartedContainer/NewFeedback/Feedback.config';
import {
  ButtonSection,
  Root,
  SectionSplitter,
  TextSection
} from '@src/GetStartedContainer/NewFeedback/Feedback.style';
import {Props} from '@src/GetStartedContainer/NewFeedback/Feedback.type';
import SelectChoices from '@src/GetStartedContainer/NewFeedback/selectChoicesNew';
...
const Feedback = ({onboardingFeedbackComplete, currentOnboardingStep}: Props): JSX.Element => {
  ...
  return (
    <Root>
      <img className="onboarding-feedback-img" src="/pages/onboarding/images/getStartedAlt.png" alt="safeKidsAiLogo"/>
      <SectionSplitter>
