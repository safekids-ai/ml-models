...
import {OnboardingStatus} from '@src/GetStartedContainer/GetStartedContainer.config';
import {ButtonSection} from '@src/GetStartedContainer/NewFeedback/Feedback.style';
...
import {
  ...
  CustomOption,
  CustomTimePicker
} from '@src/GetStartedContainer/NewFeedback/timeSpendDaily/timeSpendDaily.style';
    ...
    <Root>
      ...
      <TimeChoiceContainer>
        ...
        <div className="time-container">
          ...
          <CustomSelect id={'socialMediaTimeId'} defaultValue={socialMediaTime}
                        onChange={(value: string) => setSocialMediaTime(value)}>
            <CustomOption value="30">30 minutes</CustomOption>
            <CustomOption value="60">60 minutes</CustomOption>
            <CustomOption value="90">90 minutes</CustomOption>
            <CustomOption value="120">120 minutes</CustomOption>
      ...
      <TimeChoiceContainer>
        <div className="time-container">
          ...
          <CustomTimePicker data-testid={'disconnectTimeId'} value={disconnectTime} use12Hours format="h:mm a"
