...
import {CustomButton} from '@src/components/ResumeOnboardingPopup/resumeOnboarding.styles';
import {
  Root,
  Description,
  IconsSection,
  QuestionOval
} from '@src/components/ResumeOnboardingPopup/components/OnboardingProgress/onboardingProgress.style';
