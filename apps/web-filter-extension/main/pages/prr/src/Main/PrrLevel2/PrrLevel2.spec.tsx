...
import PrrLevel2 from './PrrLevel2';

const defaultLanguage = {name: 'English', id: 'en', direction: 'ltr'};
const Component = <PrrLevel2 level={PrrLevel.ONE} language={defaultLanguage} category="EXPLICIT"
                             siteName="www.google.com" prr2LimitExceeded={false}/>;
