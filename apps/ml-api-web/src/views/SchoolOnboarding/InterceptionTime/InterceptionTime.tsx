...
import { GET_INTERCEPTION_CATEGORIES, GET_INTERCEPTION_TIMES, PATCH_INTERCEPTION_CATEGORIES, POST_INTERCEPTION_TIME } from '../../../utils/endpoints';
...
const InterceptionTime = ({ nextStep, isSettings }: Props) => {
    ...
    return (
        <Root>
            ...
            <Description>
                By default, all previously chosen categories <b>are not available during school hours</b>, but schools may wish to allow kids to play games or
            ...
            <TimeDescription>
                Please confirm a general set of school hours for your district. Schools will have options to revise as needed later.{' '}
            </TimeDescription>
            <TimePickerContainer>
                <TimePicker
                    variant="inline"
                ...
                />
                <TimePicker variant="inline" label="School End Time" value={schoolEndTime} onChange={(value: any) => setSchoolEndTime(value)} />
            </TimePickerContainer>
            ...
            <TimePickerContainer>
                <TimePicker variant="inline" label="Day End" value={lightOffStartTime} onChange={(value: any) => setLightOffStartTime(value)} />
                <TimePicker variant="inline" label="Day Start" value={lightOffEndTime} onChange={(value: any) => setLightOffEndTime(value)} />
            </TimePickerContainer>
            {isSettings ? (
                <SaveButton>
