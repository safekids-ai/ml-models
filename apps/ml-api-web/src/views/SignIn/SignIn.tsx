                    ...
                    {({ isSubmitting, isValid }) => {
                        return (
                            <Form>
                                ...
                                <PasswordInputContainer inputProps={{ id: 'password-input-field' }} name="password" label="Password" removeSpaces />

                                <MessageContainer message={message} status="error" />
                                <SubmitBtnContainer id="signIn-button" text="Sign In" isSubmitting={isSubmitting} marginTop={0} disabled={!isValid} />
                            </Form>
                        );
                    }}
                </Formik>
