...
import { GET_PAYMENT_METHOD, GET_PLANS, GET_USER_PLAN, UPDATE_USER_PLAN, VERIFY_PROMO_CODE } from '../../../utils/endpoints';
...
export const PlanSelector = ({ nextStep, isOnBoarding = false, onRefresh }: Props): JSX.Element => {
    ...
    return loading ? (
        ...
        <Root isOnBoarding>
            ...
            <p>Your first 7 days are free, but in order to continue, you must choose a plan and provide your credit card number.</p>
            {isOnBoarding && (
