  ...
  return (
    <div className="overflow-x-clip overflow-y-visible bg-white dark:bg-gray-900 pb-24 sm:pb-32 w-screen">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none align-middle justify-end">
          <div>
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                  <div className="mx-auto max-w-5xl text-center">
                    <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl break-words overflow-hidden dark:text-white">
                      AI models to detect hate speech, adult images and internet filtering.
                    </h1>
                    <p className="mt-6 text-lg leading-8 text-gray-600 break-words overflow-hidden dark:text-slate-400">
                      A first class framework designed to run in the browser or as an API. Our models are under <span className={"font-mono font-medium text-sky-500 dark:text-sky-400"}>15MB in size</span>.
                    </p>
