import { Body, Controller, Get, HttpStatus, InternalServerErrorException, Patch, Post, Query, Request, Response, UseGuards } from '@nestjs/common';
...
export class ChromeController {
    ...
    getWebFilterConfiguration(@Request() req) {
        return this.chromeService.getWebFilterConfiguration(req.user.accountId, req.user.userId, req.user.orgUnitId);
    }
